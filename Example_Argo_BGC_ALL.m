%% ===================================================================== %%
% Dissolved oxygen map - Argo BGC 'ALL'
% ======================================================================= %
%
...
% will then compute the average value of the ajusted dissolved oxygen 
...
%
%% Download
% If you have not downloaded the database yet, just run this line first:
% download_database("ARGO","BGC",false);

parquetPath = fullfile("./data/1011_BGC_ARGO-CLOUD-MATLAB/");
...
% Combining the filters in one and assigning it to the ParquetDataset object
